...
//输出P值表
int16 UP0[7] = {770, 780, 790, 680, 810, 820, 830}; 
int16 UP1[7] = {580, 600, 620, 640, 650, 660, 670}; //OK
int16 UP2[7] = {720, 730, 740, 750, 760, 770, 780};
int16 UP3[7] = {650, 660, 670, 680, 700, 710, 720};//uff2还可以
int16 UP4[7] = {690, 700, 710, 720, 730, 740, 750};//uff1大了
...
int16 UD3[7] = {80, 90, 100, 110, 120, 125, 130}; 
                                                  //双车跟随:

int16 UFF0[7] = {  68, 70, 73, 76, 79, 82, 100};//慢档 
int16 UFF1[7] = {  77, 79, 82, 85, 88, 92  ,110};//中档 20.9S
int16 UFF2[7] = {  82, 84, 87, 90, 93, 97  ,115 };//快档

int16 UFF3[7] = {  83, 86, 90, 93, 96, 100, 118}; 
