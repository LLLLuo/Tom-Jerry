...
{    
   ...
   if(speed_duty>=0)    
    {
     ftm_pwm_duty(Motor_FTM_A,Motor_CH_B,speed_duty);
     ftm_pwm_duty(Motor_FTM_B,Motor_CH_A,0);      
    }
   else
   {        
     ftm_pwm_duty(Motor_FTM_A,Motor_CH_B,0);
     ftm_pwm_duty(Motor_FTM_B,Motor_CH_A,-speed_duty);          
